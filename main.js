...
// const filterHeight=()=>{
//     let heightFilter =users.filter((person) => person.height > 150)
...
// const filetAge=()=>{
//     let result =users.reduce((total, currency)=> total+=currency.age /users.length, 0)
//     console.log(result);
...
// const filterTitle=()=>{
//     let result = users.map((person)=>person.company.title=="Web Developer" ? person: null).filter(person=>person!==null);
//     console.log(result);
